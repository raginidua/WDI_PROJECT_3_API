...
p4 = Piece.create! name: "Painting", title: "Man Woman", description: "Figures", minimum_bid: 8000, closing_time: Time.now + 60*60*24*8, user_id: u2.id, image: "http://icacart.com/wp-content/uploads/JD0011.jpg"
p5 = Piece.create! name: "Painting", title: "Man and Woman", description: "Figures", minimum_bid: 9000, closing_time: Time.now + 60*60*24*7, user_id: u2.id, image: "http://www.verveonline.com/images/56images/life/artmart/artmart03.jpg"
p6 = Piece.create! name: "Painting", title: "Trio", description: "Figures", minimum_bid: 6000, closing_time: Time.now + 60*60*24*2, user_id: u2.id, image: "http://files.delhievents.com/images/events/2009/may/jatin_das_painting.jpg"

p7 = Piece.create! name: "Painting", title: "Rust and Blue", description: "An exploration of color", minimum_bid: 10000, closing_time: Time.now + 60*60*24*3, user_id: u3.id, image: "https://upload.wikimedia.org/wikipedia/en/5/5f/No_61_Mark_Rothko.jpg"
p8 = Piece.create! name: "Painting", title: "Black in Deep Red", description: "An exploration of color", minimum_bid: 12000, closing_time: Time.now + 60*60*24*2, user_id: u3.id, image: "http://www.markrothko.org/images/paintings/black-in-deep-red.jpg"
p9 = Piece.create! name: "Painting", title: "Untitled", description: "An exploration of color", minimum_bid: 14000, closing_time: Time.now + 60*60*24, user_id: u3.id, image: "http://www.markrothko.org/images/paintings/black-in-deep-red.jpg"

p10 = Piece.create! name: "Painting", title: "Bull", description: "A vivid depiction of a bull running", minimum_bid: 14000, closing_time: Time.now + 60*60*4, user_id: u4.id, image: "http://mediacloud.saffronart.com/exhibition/2003/works%20on%20paper%202003/pw03sunildas_03_big.jpg"
p11 = Piece.create! name: "Painting", title: "Bull 2", description: "Ferocious energy of a bull", minimum_bid: 16000, closing_time: Time.now + 60*60*2, user_id: u4.id, image: "http://www.contemporaryindianart.com/images/postindependence/suni_das-1.jpg"

p12 = Piece.create! name: "Painting", title: "Pink Angels", description: "Abstract", minimum_bid: 14000, closing_time: Time.now + 60*60, user_id: u5.id, image: "https://www.moma.org/d/assets/W1siZiIsIjIwMTUvMTAvMTQvM3lyeWRpOW82cF81MzU5OC5qcGciXSxbInAiLCJjb252ZXJ0IiwiLXJlc2l6ZSAyMDAweDIwMDBcdTAwM2UiXV0/53598.jpg?sha=56904c28a44337f2"
p13 = Piece.create! name: "Painting", title: "Woman 1", description: "Abstract", minimum_bid: 16000, closing_time: Time.now + 30, user_id: u5.id, image: "https://uploads4.wikiart.org/images/willem-de-kooning/woman-i.jpg"
...
b6 = Bid.create! user_id: u6.id, piece_id: p13.id, price: 17000
