...
u3 = User.create! email: "mark@rothko.com", password: "password", password_confirmation: "password", first_name: "Mark", last_name: "Rothko", username: "markrothko", role: "Artist", image: "http://www.nga.gov/content/dam/ngaweb/features/slideshows/Mark%20Rothko/detail-rothko.jpg", profile: "Mark Rothko, born Markus Yakovlevich Rothkowitz, was an American painter of Russian Jewish descent. Although Rothko himself refused to adhere to any art movement, he is generally identified as an abstract expressionist."
u4 = User.create! email: "sunil@das.com", password: "password", password_confirmation: "password", first_name: "Sunil", last_name: "Das", username: "sunildas", role: "Artist", image: "http://www.sunildas.net/gallery/photo/32.gif", profile: "Sunil Das was an Indian expressionist painter. He is known for the paintings in his Bull Series and his piece Woman. In 2014 the Government of India conferred upon him its fourth-highest civilian award, the Padma Shri."
u5 = User.create! email: "willem@dekooning.com", password: "password", password_confirmation: "password", first_name: "Willem", last_name: "De Kooning", username: "willemdekooning", role: "Artist", image: "https://www.biography.com/.image/c_fill,cs_srgb,dpr_1.0,g_face,h_300,q_80,w_300/MTE5NTU2MzE2MTk3MzI0Mjk5/willem-de-kooning-9270057-1-402.jpg", profile:"Willem de Kooning was a Dutch-American abstract expressionist artist who was born in Rotterdam, Netherlands, and moved to New York in 1927."
...
p10 = Piece.create! name: "Painting", title: "Orange and Yellow", description: "An exploration of color", minimum_bid: 14000, closing_time: Time.now + 60*60*24, user_id: u3.id, image: "http://www.markrothko.org/images/paintings/orange-and-yellow.jpg"
...
p19 = Piece.create! name: "Painting", title: "Untitled", description: "Abstract Impressionism", minimum_bid: 13000, closing_time: Time.now + 60*5, user_id: u5.id, image: "https://s-media-cache-ak0.pinimg.com/originals/a7/67/c9/a767c9d4c4fcbbb1da0de8672f1d32cb.jpg"

p20 = Piece.create! name: "Painting", title: "The Birthday", description: "Surrealist painting", minimum_bid: 13000, closing_time: Time.now + 60*24*4, user_id: u9.id, image: "http://totallyhistory.com/wp-content/uploads/2012/07/the-birthday-1915-Marc-Chagall.jpg"
...
p22 = Piece.create! name: "Painting", title: "The Promenade", description: "Flying woman", minimum_bid: 11000, closing_time: Time.now + 60*24*1, user_id: u9.id, image: "https://learnodo-newtonic.com/wp-content/uploads/2016/05/The-Promenade-1918-Marc-Chagall.jpg"
...
b4 = Bid.create! user_id: u7.id, piece_id: p4.id, price: 6200
b5 = Bid.create! user_id: u7.id, piece_id: p5.id, price: 8100
b6 = Bid.create! user_id: u6.id, piece_id: p6.id, price: 10000
b7 = Bid.create! user_id: u6.id, piece_id: p6.id, price: 10500
b8 = Bid.create! user_id: u7.id, piece_id: p6.id, price: 11000
b9 = Bid.create! user_id: u6.id, piece_id: p6.id, price: 11200
b10 = Bid.create! user_id: u7.id, piece_id: p7.id, price: 6100
b11 = Bid.create! user_id: u7.id, piece_id: p8.id, price: 10200
b12 = Bid.create! user_id: u7.id, piece_id: p9.id, price: 12200
b12 = Bid.create! user_id: u7.id, piece_id: p10.id, price: 14500
b13 = Bid.create! user_id: u7.id, piece_id: p11.id, price: 11300
b14 = Bid.create! user_id: u7.id, piece_id: p12.id, price: 9150
b15 = Bid.create! user_id: u7.id, piece_id: p13.id, price: 15200
b16 = Bid.create! user_id: u7.id, piece_id: p14.id, price: 14200
b17 = Bid.create! user_id: u7.id, piece_id: p15.id, price: 16100
b18 = Bid.create! user_id: u7.id, piece_id: p16.id, price: 11000
b19 = Bid.create! user_id: u7.id, piece_id: p17.id, price: 14300
b20 = Bid.create! user_id: u7.id, piece_id: p18.id, price: 16300
b21 = Bid.create! user_id: u7.id, piece_id: p19.id, price: 13300
b22 = Bid.create! user_id: u7.id, piece_id: p20.id, price: 13300
b23 = Bid.create! user_id: u7.id, piece_id: p20.id, price: 13600
b24 = Bid.create! user_id: u7.id, piece_id: p20.id, price: 13900
b25 = Bid.create! user_id: u7.id, piece_id: p21.id, price: 8300
